...
================ TODO ===========================
 * sort custom build commands by their outputs
    * Module.ExternalData
    * ExternalProjectUpdateSetup
    * ExternalProjectUpdate
 * non-source file dependencies
    * RunCMake.Configure
    * RunCMake.BuildDepends
 * implement auto exporting stuff
    * RunCMake.AutoExportDll
 * CMP0060

    Current list of unit tests failing:
================ 3.2 ===========================
77 - Module.ExternalData (Failed) -- target already defined; merge targets per
output?
...
114 - SimpleInstall-Stage2 (Failed) -- depends upon previous test
...
================ 3.3 ===========================
274 - RunCMake.CMP0060 (Failed) -- link suffix/prefix not honored
================ 3.4 ===========================
...
================ 3.5 ===========================
109 - CustomCommand (Failed) -- generated_extern.cxx not found, dependency
problem ?
...
================ master post 3.7 ===========================
 281 - RunCMake.AndroidTestUtilities (Failed) --SetupTest2 fails because of
missing file: protobuffer.p
